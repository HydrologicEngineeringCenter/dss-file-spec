...
namespace Hec.Dss.IO
{
    ...
    class RecordInfo
    {
        ...
        Decoder decoder;
        public RecordInfo(byte[] data)
        {
            decoder = new Decoder(data);
            long flag = decoder.Long(kinfoFlag);
        ...
        public RecordStatus Status
        {
            get
            {
                RecordStatus status = (RecordStatus)decoder.Integer(kinfoStatus);
                return status;
            }
        }
        ...
        public AddressInfo InternalHeaderAddress
        {
            get
            {
                return decoder.GetAddressInfo(kinfoInternalHeadAddress,
        ...
        public AddressInfo InternalHeaderAddress2
        {
            get
            {
                return decoder.GetAddressInfo(kinfoHeader2Address,
                                              kinfoHeader2Number);
            }
        }
        public AddressInfo UserHeaderAddress
        {
            get
            {
                return decoder.GetAddressInfo(kinfoUserHeadAddress,
                                              kinfoUserHeadNumber);
            }
        }
        ...
        public AddressInfo Values2Address
        {
            get
            {
                return decoder.GetAddressInfo(kinfoValues2Address,
                                              kinfoValues2Number);
            }
        }
        public AddressInfo Values3Address
        {
            get
            {
                return decoder.GetAddressInfo(kinfoValues3Address,
                                              kinfoValues3Number);
            }
        }
        ...
        public String Pathname
        {
            get
            {
                int len = decoder.Integer(kinfoPathnameLength);
                if (len <= 0)
                    return "";
                return decoder.String(kinfoPathname, len);
            }
        }
        ...
        public RecordType RecordType
        {
            get
            {
                return (RecordType)decoder.Integers(kinfoTypeVersion).Item1;
            }
        }
        ...
        public int Version
        {
            get
            {
                return decoder.Integers(kinfoTypeVersion).Item2;
            }
        }

        public int JulianStartDate
        {
            get
            {
                return decoder.Integer(kinfoFirstDate);
            }
        }

        public int JulianEndDate
        {
            get
            {
                return decoder.Integer(kinfoLastDate);
            }
        }
        ...
        public DateTime FirstDate
        {
            get
            {
                return decoder.UnixEpochDateTime(kinfoFirstDate);
            }
        }
        ...
        public DateTime LastDate
        {
            get
            {
                return decoder.UnixEpochDateTime(kinfoLastDate);
            }
        }
        ...
        public int NumberOfValues
        {
            get
            {
                return decoder.Integer(kinfoNumberData);
            }
        }
    }
}
